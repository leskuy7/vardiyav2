...
ALTER TYPE "ShiftStatus" ADD VALUE 'PROPOSED';
ALTER TYPE "ShiftStatus" ADD VALUE 'DECLINED';
ALTER TYPE "ShiftStatus" ADD VALUE 'SWAPPED';
...
-- AlterTable
ALTER TABLE "Shift" ADD COLUMN     "cancelledByLeaveRequestId" TEXT,
